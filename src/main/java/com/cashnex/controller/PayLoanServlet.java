	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    try {
	        ...
	        if (loanUpdateSuccess) {
	            ...
	            // If the loan is fully paid, update the loan status
	            ...
	            if (userUpdateSuccess) {
	                ...
	                System.out.println("UserUpdateSuccess doesn't work");
	            }
	        } else {
	            System.out.println("Loan Update doesn't work");
	        }
	    } catch (ClassNotFoundException | SQLException e) {
	        e.printStackTrace();
	        System.out.println("Everything doesn't work");
	    }
	}
